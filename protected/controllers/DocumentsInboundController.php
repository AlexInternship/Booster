...
class DocumentsInboundController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['DocumentsInbound'];
			if($model->save())
	...
	{
		$model=new DocumentsInbound('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['DocumentsInbound']))
			$model->attributes=$_GET['DocumentsInbound'];
	 ...
	 * @return DocumentsInbound the loaded model
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='documents-inbound-form')
		{
